  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-6 sm:py-8 text-right space-y-6">
            ...
            <Link
              ...
              className={`px-3.5 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition flex items-center gap-1.5 shrink-0 ${
                isSelected
                  ...
                  : "bg-[#0f1218] bg-[#0f1218] text-gray-300 text-gray-300 border border-gray-800 border-gray-800 hover:border-orange-500/50"
              }`}
            >
      ...
      <div className="p-3.5 rounded-2xl bg-[#0f1218] border border-gray-800 space-y-3 shadow-sm">
        <form method="GET" className="grid grid-cols-1 sm:grid-cols-3 gap-2.5">
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-3 pr-9 py-2 bg-[#161b24] border border-gray-700 rounded-xl text-xs text-white placeholder-gray-500 focus:outline-none focus:border-orange-500 text-right"
            />
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              type="submit"
              className="py-2 px-5 rounded-xl bg-orange-500 hover:bg-orange-600 text-black font-extrabold text-xs shrink-0 transition"
            >
              تصفية
            </button>
          </div>
        ...
        {/* Database Category Quick Pills */}
        {categories.length > 0 && (
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 pt-2 border-t border-gray-800/80">
            <Link
              ...
              className={`px-3 py-1 rounded-lg text-[11px] font-bold whitespace-nowrap transition ${
                !activeCategory || activeCategory === "all"
                  ...
                  : "bg-[#161b24] bg-[#161b24] text-gray-400 text-gray-400 hover:text-white"
              }`}
            >
              جميع التصنيفات
            </Link>
      ...
      {productsRes.items.length === 0 ? (
        <div className="py-16 text-center rounded-2xl bg-[#0f1218] border border-gray-800 space-y-3">
          ...
          <Link
            href="/shop"
            className="inline-block px-5 py-2 rounded-xl bg-orange-500 hover:bg-orange-600 text-black text-xs font-bold transition"
          >
            عرض جميع المنتجات
          </Link>
        </div>
              ...
              <Link
                ...
                className={`w-9 h-9 rounded-xl flex items-center justify-center font-bold text-xs transition ${
                  currentPage === pageNum
                    ...
                    : "bg-[#0f1218] bg-[#0f1218] border border-gray-800 border-gray-800 text-gray-300 text-gray-300 hover:text-white"
                }`}
              >
                {pageNum}
              </Link>
